...
[[ $ANDROID_ARCH == 'arm'     ]] && export ANDROID_CMAKE_ARCH=armeabi-v7a && export ANDROID_COMPILER_ARCH=armv7a &&  export ANDROID_COMPILER_SUFFIX="eabi"
...
CC="$ANDROID_NDK_HOME/toolchains/llvm/prebuilt/linux-x86_64/bin/$ANDROID_COMPILER_ARCH-linux-android$ANDROID_COMPILER_SUFFIX$ANDROID_ABI_VERSION-clang"\
  ...
  CFLAGS="-Dinline="\
  BIN="libgit2.$ANDROID_ARCH-android.so"\
